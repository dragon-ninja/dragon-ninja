...
namespace Com.Google.Android.Gms.Games.Stats
{
	public class StatsObject : JavaObjWrapper, Stats
	{
		...
		{
			return new PendingResult<Stats_LoadPlayerStatsResultObject>(InvokeCall<IntPtr>("loadPlayerStats", "(Lcom/google/android/gms/common/api/GoogleApiClient;Z)Lcom/google/android/gms/common/api/PendingResult;", new object[2]
			{
